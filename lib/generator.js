...
function placeBucket(sched, bucketLessons, blocked, relax = false, need = null, teacherDayCapMap = {}, adjBuckets = new Set()) {
  ...
  // Adjacent placement is handled in placeBucketTogether (non-alternate path).
  // Multi-teacher buckets in this alternate path (e.g. t9_0.60) are too complex for adjacency. Removed.
